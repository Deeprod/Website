<?php 
	...
	echo"
		...
		<div class='section mt-4'>
			...
			<div class='section-heading'>
				<h2 class='title'>All Movies by Rating</h2>
			</div>
	...
	for ($x = 1; $x < $Nb_Movies; $x++) 
	{
		...
		if ($x == 1 OR $movies_array[$x][4] <> $movies_array[$x-1][4]) 
		{
			
			echo"<div class='listview-title mt-1'>". $movies_array[$x][4] . "/10</div>";
		}
