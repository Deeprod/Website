<?php 
	...
	$sql = "SELECT * FROM 
			...
			WHERE
				Rating > 0
			 ORDER BY 
				Year DESC, Rating DESC, Date_Sort DESC";   
	...
	echo"
		...
		<div class='section mt-4'>
			...
			<div class='section-heading'>
				<h2 class='title'>All Movies by Year</h2>
			</div>
	...
	for ($x = 1; $x < $Nb_Movies; $x++) 
	{
		...
		if ($x == 1 OR $movies_array[$x][3] <> $movies_array[$x-1][3]) 
		{
			
			echo"<div class='listview-title mt-1'>". $movies_array[$x][3] . "</div>";
		}
